...
1. **From the Studio**: On the main dashboard, you can create a new, reusable Knowledge Base from scratch by clicking **"Create a Knowledge Base"**. This is perfect for building foundational knowledge sources (e.g., "Company-Wide Policies") that can be linked to multiple agents.
   ...
   <img
     src="/Xnapper-2025-06-11-23.58.02.png"
     alt='The "Create a Knowledge Base" option in the Studio'
     title=""
     className="mx-auto"
     style={{ width:"62%" }}
   />
2. **From the Agent Playground**: When configuring a specific agent, you can either select an existing Knowledge Base from the dropdown or click **"Manage Knowledge base"** to directly edit the sources for that agent. This is the most common way to add or update an agent's information for a specific role.
   ...
   <img
     src="/Xnapper-2025-06-11-23.58.59.png"
     alt={The "Manage Knowledge base" button within an agent's settings}
     title=""
     className="mx-auto"
     style={{ width:"65%" }}
   />
...
<img
  src="/Xnapper-2025-06-11-23.51.31.png"
  alt="The Files tab showing the drag-and-drop upload area and a list of uploaded files"
  title=""
  className="mx-auto"
  style={{ width:"55%" }}
/>
...
<img
  src="/Xnapper-2025-06-11-23.54.47.png"
  alt="The Text tab with an open input field for direct content entry"
  title=""
  className="mx-auto"
  style={{ width:"59%" }}
/>
...
<img
  src="/Xnapper-2025-06-11-23.53.13.png"
  alt="The Website tab showing the crawling options and a list of fetched links"
  title=""
  className="mx-auto"
  style={{ width:"65%" }}
/>
...
<img
  src="/Xnapper-2025-06-11-23.53.46.png"
  alt="The FAQ tab showing fields for a question and an answer"
  title=""
  className="mx-auto"
  style={{ width:"57%" }}
/>
